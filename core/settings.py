...
# OmniRoute AI Gateway — Roteador unificado em Alta Disponibilidade (LLM, OCR, TTS)
OMNIROUTE_BASE_URL = env(
    "OMNIROUTE_BASE_URL", default=env("OMNIROUTER_URL", default="https://ai.v7m.live/v1")
)
...
NOTIFY_SERVER_URL = env("NOTIFY_SERVER_URL", default="http://notify-web:8000")
...
Q_CLUSTER = {
    ...
    "ALT_CLUSTERS": {
        "slow": {
            "timeout": env.int("Q_SLOW_TIMEOUT", default=360),
            "retry": env.int("Q_SLOW_RETRY", default=420),
            "workers": env.int("Q_SLOW_WORKERS", default=1),
        }
    },
}
...
ENROLLMENT_PROMO_PRICE_CARD_CENTS = env.int(
    "ENROLLMENT_PROMO_PRICE_CARD_CENTS", default=ENROLLMENT_PRICE_CARD_CENTS
)
# Regras da BOLSA / AUTO-ESTUDO do promotor (o promotor não paga; atinge metas de indicações)
# 3 indicações pagas: libera a auto-matrícula como bolsista
# 10 indicações pagas: "quita" o curso e libera a prova final
PROMOTER_STUDY_UNLOCK_THRESHOLD = env.int("PROMOTER_STUDY_UNLOCK_THRESHOLD", default=3)
PROMOTER_STUDY_COMPLETE_THRESHOLD = env.int("PROMOTER_STUDY_COMPLETE_THRESHOLD", default=10)

# Preço legado da AUTO-MATRÍCULA do promotor (mantido para compatibilidade retroativa de leitura)
